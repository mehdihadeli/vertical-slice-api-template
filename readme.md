...
dotnet new vsa -n <YourProjectName>
```
...
8. Run `dotnet new vsa -n <YourProjectName>` for short name or `dotnet new Vertical.Slice.Template -n <YourProjectName>` to create a new project template.
