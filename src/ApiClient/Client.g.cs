...
namespace Catalogs.ApiClient
{
    ...
    public partial interface ICatalogsApiClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetGetProductsByPageResponse> GetProductByPageAsync(int pageSize, int pageNumber, string filters, string sortOrder);
        ...
        /// <returns>Products fetched successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetGetProductsByPageResponse> GetProductByPageAsync(int pageSize, int pageNumber, string filters, string sortOrder, System.Threading.CancellationToken cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetProductByIdResponse> GetProductByIdAsync(string id);
        ...
        /// <returns>Product fetched successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetProductByIdResponse> GetProductByIdAsync(string id, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class CatalogsApiClient : ICatalogsApiClient
    {
        ...
        public virtual async System.Threading.Tasks.Task<CreateProductResponse> CreateProductAsync(CreateProductRequest body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("api/v1/catalogs/products");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<HttpValidationProblemDetails>("Invalid input for creating product.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
                            ...
                            throw new ApiException<ProblemDetails>("UnAuthorized request.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
        ...
        /// <returns>Products fetched successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetGetProductsByPageResponse> GetProductByPageAsync(int pageSize, int pageNumber, string filters, string sortOrder)
        {
            return GetProductByPageAsync(pageSize, pageNumber, filters, sortOrder, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Products fetched successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetGetProductsByPageResponse> GetProductByPageAsync(int pageSize, int pageNumber, string filters, string sortOrder, System.Threading.CancellationToken cancellationToken)
        {
            if (pageSize == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetGetProductsByPageResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<HttpValidationProblemDetails>("Invalid input for getting product.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
        ...
        /// <returns>Product fetched successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetProductByIdResponse> GetProductByIdAsync(string id)
        {
        ...
        /// <returns>Product fetched successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetProductByIdResponse> GetProductByIdAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/v1/catalogs/products/{id}");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<ProblemDetails>("Product not found", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetGetProductsByPageResponse
    {
        [Newtonsoft.Json.JsonConstructor]

        public GetGetProductsByPageResponse(ProductDtoIPageList @products)
    ...
    public partial class GetProductByIdResponse
    {
        ...
        public GetProductByIdResponse(ProductLiteDto @product)
        ...
        public ProductLiteDto Product { get; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ProductLiteDto
    {
        [Newtonsoft.Json.JsonConstructor]

        public ProductLiteDto(System.Guid @id, string @name)
